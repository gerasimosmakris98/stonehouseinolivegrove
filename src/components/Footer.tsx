        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <div className="flex space-x-4 mt-4">
              <a href="#" className="text-white hover:text-villa-blue transition-colors">
          ...
          <div>
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block bg-villa-blue text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors font-medium"
            >
