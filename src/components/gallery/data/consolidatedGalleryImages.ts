...
import { generateId } from '../../../utils/galleryUtils'; // Keep generateId if it's used for IDs

export const consolidatedImages: GalleryImage[] = [
  {
  ...
  {
    id: generateId('/lovable-uploads/2886a1b0-d0a5-466e-b5b5-55acba08d3db.png'),
    src: '/lovable-uploads/2886a1b0-d0a5-466e-b5b5-55acba08d3db.png',
    category: 'interior',
    alt: 'Bathroom with washing machine'
  },
  {
    id: generateId('/lovable-uploads/fe033615-a2ab-4e55-a406-bec2da448fe8.png'),
    src: '/lovable-uploads/fe033615-a2ab-4e55-a406-bec2da448fe8.png',
    category: 'interior',
    alt: 'Small bathroom with stone wall'
  },
  {
    id: generateId('/lovable-uploads/89a05081-af6d-4bd4-bf9c-cea03f161de2.png'),
    src: '/lovable-uploads/89a05081-af6d-4bd4-bf9c-cea03f161de2.png',
    category: 'interior',
    alt: 'Single bedroom with colorful pillows'
  },
  {
    id: generateId('/lovable-uploads/6ebafc69-475a-45dd-93aa-43ddcc573674.png'),
    src: '/lovable-uploads/6ebafc69-475a-45dd-93aa-43ddcc573674.png',
    category: 'interior',
    alt: 'Single bedroom with stone wall'
  },
  {
    id: generateId('/lovable-uploads/38f784c4-7d74-4e20-92a6-6fedde129e50.png'),
    src: '/lovable-uploads/38f784c4-7d74-4e20-92a6-6fedde129e50.png',
    category: 'interior',
    alt: 'Double bedroom with metal bed frame'
  },
  {
    id: generateId('/lovable-uploads/ae8e2167-8d0c-4763-a053-97aa3ee027a3.png'),
    src: '/lovable-uploads/ae8e2167-8d0c-4763-a053-97aa3ee027a3.png',
    category: 'interior',
    alt: 'Bedroom with TV and mirror'
  },
  {
    id: generateId('/lovable-uploads/a589f49f-02b5-4ec1-ab79-16a9bc105993.png'),
    src: '/lovable-uploads/a589f49f-02b5-4ec1-ab79-16a9bc105993.png',
    category: 'interior',
    alt: 'Living and dining area with stone walls'
  },
  {
    id: generateId('/lovable-uploads/2d90b090-fa18-4efa-842e-a631cca3a403.png'),
    src: '/lovable-uploads/2d90b090-fa18-4efa-842e-a631cca3a403.png',
    category: 'interior',
    alt: 'Antique wooden cabinet with mirror'
  },
  {
    id: generateId('/lovable-uploads/247c4652-ab78-4d6f-8940-ce92a347cc5f.png'),
    src: '/lovable-uploads/247c4652-ab78-4d6f-8940-ce92a347cc5f.png',
    category: 'interior',
    alt: 'Rustic decoration against stone wall'
  },
  {
    id: generateId('/lovable-uploads/bea8479b-01e6-451b-a1d5-761a8d358608.png'),
    src: '/lovable-uploads/bea8479b-01e6-451b-a1d5-761a8d358608.png',
    category: 'interior',
    alt: 'Metal horse decoration'
  },
  {
    id: generateId('/lovable-uploads/198cfe36-0dce-4d4a-9871-d1742c9aa8cc.png'),
    src: '/lovable-uploads/198cfe36-0dce-4d4a-9871-d1742c9aa8cc.png',
    category: 'interior',
    alt: 'Small washroom with mirror'
  },
  {
    id: generateId('/lovable-uploads/2b0bb144-31f4-4f38-9179-3a575ebbc36f.png'),
    src: '/lovable-uploads/2b0bb144-31f4-4f38-9179-3a575ebbc36f.png',
    category: 'interior',
    alt: 'Decorative ceramic pitcher'
  },
  {
    id: generateId('/lovable-uploads/b8589309-1e5d-409c-a4ab-3968d5158caa.png'),
    src: '/lovable-uploads/b8589309-1e5d-409c-a4ab-3968d5158caa.png',
    category: 'interior',
    alt: 'Shower with glass doors'
  },
  {
    id: generateId('/lovable-uploads/c70c8380-0e16-413c-9af7-08bb3fab612d.png'),
    src: '/lovable-uploads/c70c8380-0e16-413c-9af7-08bb3fab612d.png',
    category: 'interior',
    alt: 'Bathroom vanity with washing machine'
  },
  {
    id: generateId('/lovable-uploads/290f7848-7c6d-46aa-a778-4c9b770c7897.png'),
    src: '/lovable-uploads/290f7848-7c6d-46aa-a778-4c9b770c7897.png',
    category: 'interior',
    alt: 'Decorative wooden plate'
  },
  {
    id: generateId('/lovable-uploads/0b6fc153-e544-4b3b-aabd-eeeda72d510d.png'),
    src: '/lovable-uploads/0b6fc153-e544-4b3b-aabd-eeeda72d510d.png',
    category: 'interior',
    alt: 'Twin beds bedroom with desk'
  },
  {
    id: generateId('/lovable-uploads/49df2f92-015c-450d-8f49-fb16d5c18bd8.png'),
    src: '/lovable-uploads/49df2f92-015c-450d-8f49-fb16d5c18bd8.png',
    category: 'interior',
